  ...
  <div class="u-ite">
    <div class="u-item">
      ...
      <div class="u-item-elem lg:w-3/12">
        <div class="u-item-elem lg:w-full">
          <template v-if="convenio.tipo == 2">
            Paga desde el primer mes
          </template>
          <template v-if="convenio.tipo == 1">
            Se regala el segundo mes
          </template>
          <template v-if="convenio.tipo == 0">
            Se regala el primer mes
          </template>
        </div>
      </div>
      <div class="u-item-elem lg:w-2/12">
      ...
      <div class="u-item-elem lg:w-1/12">
        <div class="flex">
          <nuxt-link
            ...
            :to="{ path: `/admin/convenios/ver/?uid=${convenio.id}` }"
            class="btn-accion"
          >
          ...
          <nuxt-link
            v-scroll-to="{ el: '#configuracion' }"
            :to="{ path: `/admin/convenios/editar/?uid=${convenio.id}` }"
            class="btn-accion"
          >
