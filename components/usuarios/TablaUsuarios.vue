        ...
        <div class="usuarios-tab-wrap-int">
          <div class="user-table">
            <div class="user-table-top1">
              <div class="lg:w-2/12">Plan</div>
              <div class="lg:w-1/12">Valor</div>
              <div class="lg:w-3/12">Nombre</div>
              <div class="lg:w-1/12">Documento</div>
              <div class="lg:w-2/12">Estado</div>
              <div class="lg:w-2/12">Inscrito</div>
      ...
      <nav class="paginador" aria-label="Pagination">
        ...
        <button
          v-for="i in Math.floor(
            usuarios.length > navegacionUsuario.tabUsuarioCant
          ) + 1"
          :key="i"
          href="#"
          class="btn_pag"
        ...
        <button
          ...
          @click="
            tabUsuarioPage <
            Math.floor(usuarios.length > navegacionUsuario.tabUsuarioCant)
              ? tabUsuarioPage++
              : 0
          "
        >
