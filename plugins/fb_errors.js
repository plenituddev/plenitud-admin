export default ({ context, app }, inject) => {
  inject('fb_error', (code) => {
    const errorsAuth = {
      ...
      'auth/missing-uid':
        'Se requiere un identificador para la operación actual',
